...
<div class="container">
	...
	<center><h2 style="font-family:Comic Sans MS">Employees</h2></center>
  <ul class="collection">
<?php	
include_once "func.php";  
    ...
    while($row){
	  ...
	  echo "<span class='title' style='font-size:20px;margin-left:2em'>Name: {$row['ename']}</span>"; 
     	  echo "<p>Hire Date: {$row['hdate']}</p>";
		  echo "</br>";
		  echo "</li>";
